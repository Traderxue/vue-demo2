...
<template>
  <div class="home">
    ...
    <div class="btc">
      <div>
        <span class="span1">BTC/USDT</span>
        <span class="span2">9394.16</span>
        <span class="span3">-1.81%</span>
        <span class="span4">65748.07￥</span>
      </div>
      <div>
        <span class="span1">BTC/USDT</span>
        <span class="span2">9394.16</span>
    ...
    <div class="card">
      <div class="left">
        <p>快捷买币</p>
        <span>支持BTC、USDT、ETH等</span>
        <img src="@/assets/bg_2.png" alt="" />
      </div>
      <div class="right">
        <div>
